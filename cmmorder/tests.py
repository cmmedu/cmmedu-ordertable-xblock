...
class TestEolOrderXBlock(unittest.TestCase):
    """
    A complete suite of unit tests for the EolOrder XBlock
    """

    @classmethod
    def make_an_xblock(cls, **kw):
        """
        Helper method that creates a EolOrder XBlock
        """
        ...
        xblock = EolOrderXBlock(runtime, field_data, scope_ids)
    ...
    def setUp(self):
        ...
        Creates an xblock
        """
        self.xblock = TestEolOrderXBlock.make_an_xblock()

    def test_validate_field_data(self):
        """
        Verifica que el xblock se crea correctamente con los valores por defecto
        """
        self.assertEqual(self.xblock.display_name, "Eol Order Table XBlock")
